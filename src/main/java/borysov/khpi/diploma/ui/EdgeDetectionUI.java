package borysov.khpi.diploma.ui;

import borysov.khpi.diploma.EdgeDetection;
...
/**
 * Created by Denys Borysov
 */
@Slf4j
public class EdgeDetectionUI extends JPanel{
    ...
    private JPanel fillNorthPanel() {
        ...
        filterType.addItem(EdgeDetection.HORIZONTAL_FILTER);
        filterType.addItem(EdgeDetection.VERTICAL_FILTER);

        filterType.addItem(EdgeDetection.SOBEL_FILTER_VERTICAL);
        filterType.addItem(EdgeDetection.SOBEL_FILTER_HORIZONTAL);

        filterType.addItem(EdgeDetection.SCHARR_FILTER_VETICAL);
        filterType.addItem(EdgeDetection.SCHARR_FILTER_HORIZONTAL);
